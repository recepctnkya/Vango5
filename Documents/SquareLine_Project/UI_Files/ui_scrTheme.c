...
void ui_scrTheme_screen_init(void)
{
    ...
    lv_obj_set_x(ui_btnWhiteTheme, -91);
    lv_obj_set_y(ui_btnWhiteTheme, -175);
    ...
    lv_obj_set_width(ui_rlrTime, 439);
    lv_obj_set_height(ui_rlrTime, 100);
    lv_obj_set_x(ui_rlrTime, 22);
    lv_obj_set_y(ui_rlrTime, 93);
    ...
    lv_obj_set_width(ui_swEnableWallpaper, 130);
    lv_obj_set_height(ui_swEnableWallpaper, 94);
    lv_obj_set_x(ui_swEnableWallpaper, 36);
    lv_obj_set_y(ui_swEnableWallpaper, -13);
    ...
    lv_obj_set_x(ui_lblWallpaper, -307);
    lv_obj_set_y(ui_lblWallpaper, -17);
    lv_obj_set_align(ui_lblWallpaper, LV_ALIGN_CENTER);
    lv_label_set_text(ui_lblWallpaper, "Enable Wallpaper:");
    lv_obj_set_style_text_font(ui_lblWallpaper, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
