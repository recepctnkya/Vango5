...
void ui_scrPages_screen_init(void)
{
    ...
    lv_obj_set_x(ui_btnDims, -366);
    lv_obj_set_y(ui_btnDims, 8);
    ...
    lv_obj_set_x(ui_btnTemperatures, -131);
    lv_obj_set_y(ui_btnTemperatures, 11);
    ...
    lv_obj_set_x(ui_btnWaters, 96);
    lv_obj_set_y(ui_btnWaters, 15);
    ...
    lv_obj_set_x(ui_btnRGBs, 333);
    lv_obj_set_y(ui_btnRGBs, 17);
    ...
    lv_obj_set_x(ui_Button12, 391);
    lv_obj_set_y(ui_Button12, -221);
