...
void ui_scrTheme_screen_init(void)
{
    ...
    lv_obj_set_y(ui_btnWhiteTheme, -42);
    ...
    lv_obj_set_x(ui_btnBlackTheme, 140);
    lv_obj_set_y(ui_btnBlackTheme, -38);
    ...
    lv_obj_set_x(ui_lblSelectTheme, -292);
    lv_obj_set_y(ui_lblSelectTheme, -34);
