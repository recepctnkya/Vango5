...
void ui_scrPages_screen_init(void)
{
    ...
    lv_obj_set_style_bg_opa(ui_scrPages, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Panel7 = lv_obj_create(ui_scrPages);
    lv_obj_set_width(ui_Panel7, 1031);
    lv_obj_set_height(ui_Panel7, 42);
    lv_obj_set_x(ui_Panel7, 1);
    lv_obj_set_y(ui_Panel7, 281);
    ...
    lv_obj_set_height(ui_Button12, 95);
    lv_obj_set_x(ui_Button12, 429);
    lv_obj_set_y(ui_Button12, -244);
    ...
    lv_obj_set_x(ui_Button19, -448);
    lv_obj_set_y(ui_Button19, 247);
    ...
    lv_obj_set_x(ui_lblSensorsB, -143);
    lv_obj_set_y(ui_lblSensorsB, 142);
    ...
    lv_obj_set_x(ui_lblWaterLevelsB, 96);
    lv_obj_set_y(ui_lblWaterLevelsB, 156);
    ...
    lv_obj_set_x(ui_btnDims, -370);
    lv_obj_set_y(ui_btnDims, -26);
    ...
    lv_img_set_zoom(ui_btnDims, 400);
    ...
    lv_obj_set_x(ui_btnTemperatures, -125);
    lv_obj_set_y(ui_btnTemperatures, -24);
    ...
    lv_img_set_zoom(ui_btnTemperatures, 400);
    ...
    lv_obj_set_x(ui_btnWaters, 117);
    lv_obj_set_y(ui_btnWaters, -20);
    ...
    lv_img_set_zoom(ui_btnWaters, 400);
    ...
    lv_obj_set_x(ui_btnRGBs, 363);
    lv_obj_set_y(ui_btnRGBs, -25);
    ...
    lv_img_set_zoom(ui_btnRGBs, 400);
